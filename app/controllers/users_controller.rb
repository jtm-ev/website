...
class UsersController < ApplicationController
  ...
  def edit
    @roles = [
      Role.find_or_create_by(name: 'member_manager'),
      Role.find_or_create_by(name: 'site_manager'),
      Role.find_or_create_by(name: 'project_manager')
    ]
    @roles.push Role.find_or_create_by(name: 'admin') if current_user.has_role?(:admin)
  end
