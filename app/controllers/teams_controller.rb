...
class TeamsController < ApplicationController
  ...
  def create
    ...
    redirect_to edit_intern_project_team_path(@project, @team)
  end
  
  def edit
    add_breadcrumb @team.project.title, edit_intern_project_path(@team.project, anchor: 'teams')
  ...
  def destroy
    ...
    redirect_to edit_intern_project_path(project, anchor: 'teams')
  end
